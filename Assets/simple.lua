...
mat1 = gr.material({0.7, 1.0, 0.7}, {0.5, 0.7, 0.5}, 25) -- green
mat2 = gr.material({0.5, 0.5, 0.5}, {0.5, 0.7, 0.5}, 25) -- grey
mat3 = gr.material({1.0, 0.6, 0.1}, {0.5, 0.7, 0.5}, 25) -- orange
...
-- delete
--p2 = gr.nh_box('p2', {-100, -100, 0}, 200)
--scene_root:add_child(p2)
--p2:set_material(mat3)

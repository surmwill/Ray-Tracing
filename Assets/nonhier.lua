...
mat1 = gr.refl_material({0.7, 1.0, 0.7}, {0.5, 0.7, 0.5}, 25, 0.0)
mat2 = gr.refl_material({0.5, 0.5, 0.5}, {0.5, 0.7, 0.5}, 25, 0.0)
mat3 = gr.refl_material({1.0, 0.6, 0.1}, {0.5, 0.7, 0.5}, 25, 0.0)
mat4 = gr.refl_material({0.7, 0.6, 1.0}, {0.5, 0.4, 0.8}, 25, 0.0)
